    ...
    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
      ...
      <div className="flex items-center gap-2 p-3 rounded-xl bg-gray-50 border border-gray-200">
        ...
        <div>
          ...
          <p className="text-gray-600 text-xs">semanas de racha</p>
        </div>
      </div>
      ...
      <div className="flex items-center gap-2 p-3 rounded-xl bg-gray-50 border border-gray-200">
        ...
        <div>
          ...
          <p className="text-gray-600 text-xs">palabras escritas</p>
        </div>
      </div>
      ...
      <div className="flex items-center gap-2 p-3 rounded-xl bg-gray-50 border border-gray-200">
        ...
        <div>
          ...
          <p className="text-gray-600 text-xs">días de racha</p>
        </div>
      </div>
      ...
      <div className="flex items-center gap-2 p-3 rounded-xl bg-gray-50 border border-gray-200">
        ...
        <div>
          ...
          <p className="text-gray-600 text-xs">notas este mes</p>
        </div>
      </div>
    </div>
  );
